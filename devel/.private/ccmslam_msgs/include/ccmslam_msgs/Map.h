...
struct Map_
{
  ...
  _mMsgId_type mMsgId;
   ...
   typedef std::vector< ::ccmslam_msgs::KF_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::KF_<ContainerAllocator> >::other >  _Keyframes_type;
  _Keyframes_type Keyframes;

   typedef std::vector< ::ccmslam_msgs::KFred_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::KFred_<ContainerAllocator> >::other >  _KFUpdates_type;
  _KFUpdates_type KFUpdates;

   typedef std::vector< ::ccmslam_msgs::MP_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::MP_<ContainerAllocator> >::other >  _MapPoints_type;
  _MapPoints_type MapPoints;

   typedef std::vector< ::ccmslam_msgs::MPred_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::MPred_<ContainerAllocator> >::other >  _MPUpdates_type;
  _MPUpdates_type MPUpdates;

   typedef std::vector<uint16_t, typename ContainerAllocator::template rebind<uint16_t>::other >  _vAckKFs_type;
  _vAckKFs_type vAckKFs;

   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _vAckMPs_type;
