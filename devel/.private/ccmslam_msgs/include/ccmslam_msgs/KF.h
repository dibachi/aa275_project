...
struct KF_
{
  ...
  _N_type N;
   ...
   typedef std::vector< ::ccmslam_msgs::CvKeyPoint_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::CvKeyPoint_<ContainerAllocator> >::other >  _mvKeysUn_type;
  _mvKeysUn_type mvKeysUn;

   typedef std::vector< ::ccmslam_msgs::Descriptor_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ccmslam_msgs::Descriptor_<ContainerAllocator> >::other >  _mDescriptors_type;
  ...
  _mK_type mK;
   ...
   typedef std::vector<uint32_t, typename ContainerAllocator::template rebind<uint32_t>::other >  _mvpMapPoints_Ids_type;
  _mvpMapPoints_Ids_type mvpMapPoints_Ids;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _mvpMapPoints_ClientIds_type;
  _mvpMapPoints_ClientIds_type mvpMapPoints_ClientIds;

   typedef std::vector<uint16_t, typename ContainerAllocator::template rebind<uint16_t>::other >  _mvpMapPoints_VectId_type;
